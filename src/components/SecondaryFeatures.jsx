...
const features = [
        ...
        <>
          <defs>
            ...
            >
              ...
              <stop offset={1} stopColor="#04748e" />
            </linearGradient>
          </defs>
          <path
  ...
  },
  {
    name: 'Our Staff',
    summary:
      'Instructors are also important as or more than students for driving schools.',
    description:
      'Let you keep an eye on your staffs moreover paying salaries.',
    image: ourstaff,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: isActive ? '#04748e' : '#4A5568' }}
      >
      ...
      <h3
        ...
        style={{ color: isActive ? '#04748e' : '#4A5568' }}
      >
        {feature.name}
      </h3>
